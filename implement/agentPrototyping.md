...
Apply guidance to specific code or tasks File-based instructions Apply React conventions when the agent works with .tsx files Included when files match a pattern or the task matches the description
